...
export default function PostPurchaseTab() {
  ...
  const [subTab, setSubTab] = useState<"offers" | "stats" | "help">("offers");
  ...
  return (
    <PolarisProvider>
      <>
        ...
        {/* ── Help tab ── */}
        {subTab === "help" && (
          <div style={{ background: "#fff", borderRadius: "12px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", padding: "1.5rem" }}>
            <p style={{ margin: "0 0 0.5rem", fontWeight: 700, fontSize: "1rem", color: "#111827" }}>Do you need any help?</p>
            <p style={{ margin: "0 0 1.5rem", fontSize: "0.9rem", color: "#6b7280", lineHeight: 1.6 }}>
              You can browse our app guide to understand post-purchase offers, read simple examples, and get setup help whenever you need it.
            </p>
